...
from tui import Tui
from src.les_exceptions.le_pendu.application.helpers import getProjectRoot
...
def main() -> int:
    ...
    while boucle:
        ...
        tui.jeu.recupererMotAleatoire(Path(getProjectRoot() / "les_exceptions" / "le_pendu" / "french"))
